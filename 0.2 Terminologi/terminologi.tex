...
\newline
\textbf{\textit{Web crawler}} - En web crawler er et program som systematisk går igjennom alle nettsider på Internett. Denne kan ha mange hensikter, men vanligvis er hensikten å indeksere sidene, typisk for store søkemotorer som Google, Bing og Yahoo. \endnote{Tarjei Romtveit, Load-balancing by applying a bayesian learning automata (BLA) scheme in a non-stationary web-crawler network(Universitetet i Agder, 2010), 14} \newline
\newline
